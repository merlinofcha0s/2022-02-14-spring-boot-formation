package com.plb.vinylmgt.resources;
...
public class UserResourceIT {
    ...
    @Test
    @WithMockUser(roles = {"USER"}, username = "toto")
    public void getAllShouldWork() throws Exception {
        User user1 = userRepository.save(user);
        User user2 = UserServiceTest.createEntity();
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/users"))
                ...
                .andExpect(jsonPath("$.[*].id")
                        .value(hasItems(user1.getId().intValue(), user2.getId().intValue())))
    ...
    public void deleteUserNotFound() throws Exception {
        mockMvc.perform(delete("/api/users/{id}", 5456L)
                        .accept(MediaType.APPLICATION_JSON))
